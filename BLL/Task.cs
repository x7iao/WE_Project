...
namespace WE_Project.BLL
{
    public class Task
    {
        ...
        {
            DAL.Task.SendTask(BLL.Member.ManageMember.TModel, to, "001", msg, 0);
        }

        public static void ReplyTask(Model.Member to, string msg, int replyId)
        {
            DAL.Task.SendTask(BLL.Member.ManageMember.TModel, to, "001", msg, replyId);
        }

        public static void SendManage(Model.Member from, string ttype, string msg)
        {
            DAL.Task.SendTask(from, BLL.Member.ManageMember.TModel, ttype, msg, 0);
        }
        ...
        public static WE_Project.Model.Task GetModel(string obj)
        {
            return WE_Project.DAL.Task.GetModel(obj);
        }
        ...
        {
            return DAL.Task.ReadTask(idlist);
        }
    }
}
