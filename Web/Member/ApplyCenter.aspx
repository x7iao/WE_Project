<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApplyCenter.aspx.cs" Inherits="WE_Project.Web.Member.ApplyCenter" %>
    ...
    <div id="mempay">
        <div id="finance">
           ...
           <tr>
                    ...
                    <td width="35%">
                     <div class="conte">
                      <span id="spTreatment" runat="server">
                ...
                <%if (type == "region")
                 ...
                 <tr>
                  <td width="15%" align="right">
                    ...
                    <td width="35%">
                       <input id="txtProvince" runat="server" class="normal_input" type="text" maxlength="20"  readonly="readonly"/>
                    </td>
                </tr>
                       <tr>
                  <td width="15%" align="right">
                    ...
                    <td width="35%">
                       <input id="txtQQGroup" runat="server" class="normal_input" type="text" maxlength="20" />
                    </td>
                </tr>
                  <tr>
                  <td width="15%" align="right">
                    ...
                    <td width="35%">
                       <input id="txtQQ" runat="server" class="normal_input" type="text" maxlength="20" />
                    </td>
                </tr>
                  <tr>
                  <td width="15%" align="right">
                    ...
                    <td width="35%">
                       <input id="txtTel" runat="server" class="normal_input" type="text" maxlength="20" />
                    </td>
                </tr>
                <%} %>
                <tr>
    ...
    <script type="text/javascript">
        ...
        function cancleChange() {
            verifypsd(function () {
                $.ajax({
                    type: 'post',
                    url: '/Member/ApplyCenter.aspx?Action=MODIFY',
