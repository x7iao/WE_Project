<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActiveCodeList.aspx.cs"
    Inherits="WE_Project.Web.Member.ActiveCodeList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        tUrl = "/Handler/ActiveCodeList2.ashx";
        tState = "zc";
        SearchByCondition();
    </script>
</head>
        ...
        <div class="control">
            <div class="select">
                <a href="javascript:void(0);" onclick="SearchByState('zc',this);" class="btn btn-danger">
                    转出记录</a>&nbsp;<a href="javascript:void(0)" onclick="SearchByState('zr',this);" class="btn btn-success">转入记录</a></div>
