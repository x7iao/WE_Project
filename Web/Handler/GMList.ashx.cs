...
namespace WE_Project.Web.Handler
{
    ...
    public class GMList : BaseHandler
    {
        public override void ProcessRequest(HttpContext context)
        {
            ...
            {
                ListChangeMoney = BllModel.GetChangeMoneyEntityList("", TModel.MID, "", "true", new List<string> { "CZ", "KZ" }, new List<string> { "MHB", "MJB", "MGP", "CTD" }, pageIndex, pageSize, strWhere, out count);
            }
            else
            {
                ListChangeMoney = BllModel.GetChangeMoneyEntityList("", mKey, "", "true", new List<string> { "CZ", "KZ" }, new List<string> { "MHB", "MJB", "MGP", "CTD" }, pageIndex, pageSize, strWhere, out count);
