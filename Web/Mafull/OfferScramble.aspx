<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OfferScramble.aspx.cs"
    Inherits="WE_Project.Web.Mafull.OfferScramble" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        tUrl = "/Mafull/Handler/OfferScramble.ashx";
        SearchByCondition();
    </script>
</head>
<body>
        ...
        <div class="ui_table">
            ...
            <div class="ui_table_control">
                ...
                <div class="pn" id="DivDelete" runat="server">
                    <a href="javascript:void(0);" onclick="RunAjaxByList('','DeleteOffer',',');">删除</a>
                </div>
                <div class="pagebar">
                    <div id="Pagination">
                    </div>
