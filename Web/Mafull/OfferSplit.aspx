<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OfferSplit.aspx.cs" Inherits="WE_Project.Web.Mafull.OfferSplit" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        tUrl = "/Mafull/Handler/OfferSplit.ashx";
        SearchByCondition();
        function OfferSplit(id) {
            verifypsd(function () {
                var txtvalue = $("#txtSplit_" + id).val();
                var relVal = RunAjaxGetKey('OfferSplit', txtvalue + "~" + id);
                if (relVal == "1") {
