...
{
    public partial class TaskReply : BasePage
    {
        ...
        public Model.Task TaskModel
        {
            get
            {
                ...
                //model.PicURL = Request.Form["uploadPic"];
                model.PicURL = Request.Form["hduploadPic1"];
                model.ReplyID = int.Parse(Request.Form["taskID"]);
                return model;
            }
        }
