<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HBJL.aspx.cs" Inherits="WE_Project.Web.ChangeMoney.HBJL"
        ...
        <div id="finance">
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>
                        <input class="pay btn btn-success" id="btnOK" type="button" runat="server" value="提交" onclick="checkChange();" />
                    </td>
                </tr>
            </table>
            </form>
