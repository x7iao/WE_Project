<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GrantPowers.aspx.cs" Inherits="WE_Project.Web.SysManage.GrantPowers" %>
    ...
    <div id="mempay">
        <div class="control">
            ...
            <div class="search" id="DivSearch" runat="server">
                       <input id="startDate" name="txtKey"  placeholder="请输入菜单名称" style="width: 150px;"  type="text" class="sinput" />
            ...
            <div class="cheeckbox">
                <table cellpadding="0" cellspacing="0">
                    <tr>
                        <td>
                            <select id="txtKey" name="txtKey" runat="server" onclick="SearchByCondition();">
                            </select>
                        </td>
                    </tr>
                </table>
        ...
        <div class="ui_table">
            ...
            <div class="ui_table_control">
                ...
                <div class="pn">
                    <a href="javascript:void(0);" title="" onclick="RunAjaxByList('','GrantVerify&mType='+$('#txtKey').val(),',');">
                        重新授权</a>
                </div>
                <div class="pagebar">
                    <div id="Pagination">
