<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RolePowers.aspx.cs" Inherits="WE_Project.Web.SysManage.RolePowers" %>
        ...
        <div class="control">
            ...
            <div class="cheeckbox">
                <table cellpadding="0" cellspacing="0">
                    <tr>
                        <td>
                            <select id="RoleCode" name="txtKey" onclick="SearchByCondition()">
                                <%= RoleListStr%>
                            </select>
                        </td>
                    </tr>
