...
namespace WE_Project.DAL
{
    ...
    public class HKModel
    {
        public static Hashtable Insert(Model.HKModel model, Hashtable MyHs)
        {
            ...
            StringBuilder sb = new StringBuilder("insert into HKModel (BankName,FromBank,HKCode,HKCreateDate,HKDate,HKState,HKType,MID,RealMoney,ToBank,ValidMoney,IsAuto,Sign,Remark,ConfirmTime) ");
            sb.Append("values");
            sb.Append("(@BankName,@FromBank,@HKCode,@HKCreateDate,@HKDate,@HKState,@HKType,@MID,@RealMoney,@ToBank,@ValidMoney,@IsAuto,@Sign,@Remark,@ConfirmTime);");
            ...
            parameters[14].Value = model.ConfirmTime;
        ...
        public static Hashtable Update(Model.HKModel model, Hashtable MyHs)
        {
            ...
            sb.Append("ConfirmTime=@ConfirmTime ");
            sb.Append(" where ");
        ...
        private static DataTable GetTable(string strWhere, int pageIndex, int pageSize, out int count)
        {
            ...
            parameters[4].Value = "HKCreateDate asc,HKCode asc";
