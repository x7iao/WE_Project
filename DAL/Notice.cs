...
namespace WE_Project.DAL
{
    public class Notice
    {
        ...
        {
            string sb = "insert into Notice(NTitle,NContent,IsFixed) values (@NTitle,@NContent,@IsFixed)";
        ...
        {
            string sb = "Update Notice set NTitle=@NTitle,NContent=@NContent,NState=@NState,IsFixed=@IsFixed where ID=@ID";
            SqlParameter[] para = new SqlParameter[]
            {
                new SqlParameter("@NTitle", SqlDbType.NVarChar,200),
                new SqlParameter("@NContent",SqlDbType.Text),
        ...
        public static DataTable GetNoticeList(string strWhere)
        {
        ...
        public static List<Model.Notice> GetNoticeLists(int top)
        {
            List<Model.Notice> NoticeList = new List<Model.Notice>();
            StringBuilder strSql = new StringBuilder();
