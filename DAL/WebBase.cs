...
namespace WE_Project.DAL
{
    public static class WebBase
    {
        ...
        public static Model.WebBase GetModel(object obj)
        {
            ...
            strSql.Append("select  top 1 * from WebBase ");

            WE_Project.Model.WebBase model = new WE_Project.Model.WebBase();
        ...
        private static WE_Project.Model.WebBase DataRowToModel(DataRow row)
        {
            WE_Project.Model.WebBase model = new WE_Project.Model.WebBase();
            if (row != null)
            {
