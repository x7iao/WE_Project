...
namespace WE_Project.DAL
{
    ...
    public class EPJX
    {
        ...
        /// 得到一个对象实体
        /// </summary>
        public static WE_Project.Model.EPJX GetModel(object JXID)
        {
        ...
        {
            List<WE_Project.Model.EPJX> list = new List<WE_Project.Model.EPJX>();
        ...
        /// 获得实体列表
        /// </summary>
        public static List<WE_Project.Model.EPJX> GetList(int top, string strWhere)
        {
            List<WE_Project.Model.EPJX> list = new List<WE_Project.Model.EPJX>();
        ...
        ///  实体转换
        /// <summary>
        private static WE_Project.Model.EPJX TranEntity(DataRow dr)
        {
            if (dr != null)
            {
                WE_Project.Model.EPJX model = new WE_Project.Model.EPJX();
